        ...
        <div className="w-full flex flex-col  space-y-6 justify-center items-center">
            ...
            {!timer.isRunning && (
                <div className="w-full flex flex-col items-center justify-center max-w-md  ">
                    <label className="block text-sm font-medium text-gray-300">Training Duration (minutes)</label>
                    <input
                        type="number"
                        placeholder="Enter your training duration"
                        className="w-full px-3 py-2 rounded-lg border border-gray-600 bg-gray-800 text-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            ...
            <div className="w-full max-w-md bg-gray-800/50 rounded-xl p-4 border border-gray-700">
                <div className="flex justify-between items-center mb-3">
                    ...
                    <span className={`font-bold ${skillLevel === 'master' ? 'text-purple-400' :
